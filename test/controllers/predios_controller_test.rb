...
class PrediosControllerTest < ActionController::TestCase
  ...
  test "should create predio" do
    assert_difference('Predio.count') do
      post :create, predio: { cantidad_canchas: @predio.cantidad_canchas, direccion: @predio.direccion, nombre: @predio.nombre, telefono: @predio.telefono }
    end
  ...
  test "should update predio" do
    patch :update, id: @predio, predio: { cantidad_canchas: @predio.cantidad_canchas, direccion: @predio.direccion, nombre: @predio.nombre, telefono: @predio.telefono }
    assert_redirected_to predio_path(assigns(:predio))
  end
