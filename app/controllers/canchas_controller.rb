class CanchasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cancha.save
        format.html { redirect_to @cancha, notice: 'Cancha fue creada satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @cancha.update(cancha_params)
        format.html { redirect_to @cancha, notice: 'Cancha fue actualizada satisfactoriamente.' }
  ...
  def destroy
    @cancha.destroy
    respond_to do |format|
      format.html { redirect_to canchas_url, notice: 'Cancha fue eliminada satisfactoriamente.' }
  ...
  private
    ...
    def cancha_params
      params.require(:cancha).permit(:numero_cancha, :horario)
    end
end
